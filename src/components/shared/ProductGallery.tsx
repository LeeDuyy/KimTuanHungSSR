...
function ProductGallery(props: ProductGalleryProps) {
    ...
    const openPhotoswipe = (index: number) => {
        ...
        const items = imagesRefs.current.map((tag, index) => {
            ...
            return {
                src: IMAGE_FOLDER + images[index],
                msrc: IMAGE_FOLDER + images[index],
                w: width,
                h: height,
            };
        });
        ...
        return (
            ...
            >
                <div className="product-image__body">
                    <img className="product-image__img product-gallery__carousel-image" src={`${IMAGE_FOLDER}${image}`} alt="" />
                </div>
            </button>
        );
    });
