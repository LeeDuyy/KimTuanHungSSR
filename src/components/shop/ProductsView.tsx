...
function ProductsView(props: ProductsViewProps) {
    ...
    const viewModesDef: ViewMode[] = [
        { key: 'grid', title: 'Lưới', icon: <LayoutGrid16x16Svg /> },
        { key: 'grid-with-features', title: 'Thông số', icon: <LayoutGridWithDetails16x16Svg /> },
        { key: 'list', title: 'Danh sách', icon: <LayoutList16x16Svg /> },
    ];
    ...
    const productsListItems = productsList.map((product, idx) => (
        <div key={idx} className="products-list__item">
    ...
    if (productsListItems.length > 0) {
            ...
            <div className="products-view__content">
                <div className="products-view__options">
                    <div className={viewOptionsClasses}>
                        ...
                        <div className="view-options__control">
                            <label htmlFor="view-options-limit">Hiển thị</label>
                            <div>
                                <select
                ...
                <div className="products-view__pagination">
                    <Pagination
                        ...
                        siblings={2}
                        total={productsList[0].total_page}
        ...
        content = (
            <div className="products-view__empty">
                <div className="products-view__empty-title">Không có sản phẩm.</div>
                <div className="products-view__empty-subtitle">Vui lòng truy cập vào danh mục khác.</div>
